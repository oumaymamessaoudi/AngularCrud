              ...
              if (result === 'confirm') {
                ...
                this.apiService.deleteVille(id).subscribe(
                  () => {
                    ...
                    this.villes.splice(villeIndex, 1); // Remove the ville from the villes array
                    this.dataSource2.data = [...this.villes]; // Update the data source with the modified villes array
                  },
                  (error: any) => {
